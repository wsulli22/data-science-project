...
#ONLY TAKE 10 RECENT GAMES FOR TESTING PURPOSES
LIMIT = 10
...
kalshi_games_list = get_list_of_all_kalshi_college_basketball_games(limit=LIMIT)
...
mapped_games = map_espn_kalshi_games(limit=LIMIT)
